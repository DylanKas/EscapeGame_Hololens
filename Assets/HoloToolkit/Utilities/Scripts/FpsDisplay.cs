...
namespace HoloToolkit.Unity
{
    ...
    public class FpsDisplay : MonoBehaviour
    {
        ...
        {
            PlayerPrefs.SetInt("healthPoints", -1);
            if (textMesh == null)
            {
        ...
        {
            if (PlayerPrefs.GetInt("healthPoints") != -1)
            {
                string displayString = "Vie: " + PlayerPrefs.GetInt("healthPoints").ToString();
                if (PlayerPrefs.GetInt("healthPoints") < 0)
                {
                    PlayerPrefs.SetInt("healthPoints", 0);
                    displayString = "Vie: 0, malus de score";
                }
                if (textMesh != null)
                {
