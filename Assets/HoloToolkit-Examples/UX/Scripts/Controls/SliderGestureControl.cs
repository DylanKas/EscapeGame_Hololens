...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    public class SliderGestureControl : GestureInteractiveControl
    {
        ...
        protected override void Awake()
        {
            ...
            PlayerPrefs.SetInt("slider1", 0);
            PlayerPrefs.SetInt("slider2", 0);
            PlayerPrefs.SetInt("slider3", 0);
            if (Knob != null)
            {
        ...
        private void UpdateVisuals()
        {
            ...
            if (Label != null)
            {
                float displayValue = SliderValue+1;
                if (Centered)
                {
                ...
                Debug.Log(" 1: " + PlayerPrefs.GetInt("slider1")+" 2: " + PlayerPrefs.GetInt("slider2")+" 3: " + PlayerPrefs.GetInt("slider3"));
                string textToDisplay = Mathf.Round(displayValue).ToString(LabelFormat); ;
                //Debug.Log("TxtToDisplay: '" + textToDisplay+"'");
                if (isSlider == 0) {
        ...
        protected override void Update()
        {
            ...
            if (valueSlider == 1 && !((mSliderValue) >= 55.5 && (mSliderValue) <= 56.5))
            {
                string v = "slider1";
                PlayerPrefs.SetInt(v, 0);
            }
            else if (valueSlider == 2 && !((mSliderValue) >= 17.5 && (mSliderValue) <= 18.5))
            {
                string v = "slider2";
                PlayerPrefs.SetInt(v, 0);
            }
            else if (valueSlider == 3 && !((mSliderValue) >= 77.5 && (mSliderValue) <= 78.5))
            {
                string v = "slider3";
                PlayerPrefs.SetInt(v, 0);
            }
